...
# Optional whitespace, Upstream Status with optional hyphen or space, maybe a
# colon, some whitespace, then the first word, case insensitive.
status_re = re.compile(r"\n?[\t ]*(Upstream[- ]Status:?)[\t ]*(\w*)", re.IGNORECASE)

status_values = ("accepted", "pending", "inappropriate", "backport", "submitted", "denied", "rejected")
